...
namespace WebApplication
{
    public class Data
    {
        ...
        public DataTable GetRandomDataRecords(int noOfRecords)
        {
            try
            {
                string mail = HttpContext.Current.Request.Cookies["salngName"].Value;
                con.Open();
        ...
        static void RemoveLoggedInUser(DataTable dataTable, string loggedInUser)
        {
            DataRow[] rowsToRemove = dataTable.Select($"Name = '{loggedInUser}'");
