                    ...
                    <div class="card h-100">
                      <div class="position-relative">
                        ...
                        <div class="badge bg-danger text-white mt-2 me-2 position-absolute top-0 end-0">
                          <asp:Label ID="lblRequestedFor" runat="server" Text='<%# Eval("RequestType") %>'></asp:Label>
                        </div>
                      </div>
                      <div class="card-body position-relative pt-0">
                        ...
                        <p class="mb-0 small mx-auto" style="display: flex; justify-content: space-between; align-items: center;width:100%"> 
                        ...
                        <h6 class="mt-3"> <a > <asp:Label ID="lblAbout" runat="server" Text='<%# Eval("about") %>'></asp:Label> </a> </h6>
                          <hr />
                        <h5>Interests:</h5>
                        <asp:Repeater ID="rptUserInterests" runat="server" OnItemDataBound="rptUserInterests_ItemDataBound">
                        <ItemTemplate>
                            <asp:Label ID="lblInterest" runat="server" Text="" class="small text-secondary" style="border: 1px solid gray;padding:5px;margin:5px;"></asp:Label>
                        </ItemTemplate>
                        </asp:Repeater>
                        <div class="d-flex mt-3 justify-content-between">
                          ...
                          <div class="w-100">
                            <label class="btn btn-sm btn-outline-success d-block" for="Interested1"><i class="bi bi-envelope fa-fw pe-1"></i>Message</label>
                          </div>
                        </div>
                      </div>
                  </div>
